...
- Critères de la grille : **100** — F1:4 F2:12 F3:21 F4:11 F5:39 F6:6 F7:5 F8:2 *(relevé du 2026-09-24)*
- Apps mesurées : **10** ; dénominateur par app : **84 à 99** (un critère **non applicable** sort du calcul)
