...
3. ~~`common/templates/common/_settings_modal.html` — modal paramètres générique~~ **LIVRÉ AUTREMENT
   ...
   synthesizer, composer, describer et avatarizer (24/09) — **8/10 mesuré**
   (`settings_modal_cycle`) ; restent converter (modale à valeurs chargées par `status`, profils,
   reset : une passe dédiée) et transcriber (`ROUTE §F3`).
...
> ⚠ **Remesuré le 2026-09-24 : 881/933** — `settings_modal_cycle` 8/10 (reader, synthesizer,
> composer, describer, avatarizer ralliés ; restent converter, transcriber) et `recursive_import`
