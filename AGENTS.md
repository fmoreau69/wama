...
3. ~~`common/templates/common/_settings_modal.html` — modal paramètres générique~~ **LIVRÉ AUTREMENT
   ...
   synthesizer, composer, describer, avatarizer et converter (24/09) — **9/10 mesuré**
   (`settings_modal_cycle`) ; reste le transcriber (`ROUTE §F3`).
...
> ⚠ **Remesuré le 2026-09-24 : 882/933** — `settings_modal_cycle` 9/10 (reader, synthesizer,
> composer, describer, avatarizer, converter ralliés ; reste transcriber) et `recursive_import`
