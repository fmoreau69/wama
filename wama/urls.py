...
urlpatterns = [
    ...
    path('api/tools/converter/convert/', tool_views.convert_file_view,          name='tool_converter_convert'),
    path('api/tools/converter/status/',  tool_views.get_converter_status_view,  name='tool_converter_status'),
