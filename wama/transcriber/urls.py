...
urlpatterns = [
    ...
    path('edit/<int:pk>/retime/', views.retime_segments, name='retime_segments'),
    path('edit/<int:pk>/write-cursor/', views.write_cursor, name='write_cursor'),
    path('edit/<int:pk>/write-results/', views.write_results, name='write_results'),
