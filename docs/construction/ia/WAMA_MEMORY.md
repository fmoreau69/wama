...
> dispersées dans `PROJECT_STATUS §6`, `ROADMAP §16.2/§16.7` et `docs/construction/archive/WAMA_Vision_Complet_v2.md §11`
> (le doc de vision actuel, `docs/construction/mondes/WAMA_VISION_COMPLET.md §5.5`, reflète le substrat réel)
