"""LocateAnythingWorker — classe d'inférence officielle NVIDIA, recopiée verbatim du README
du snapshot HF (nvidia/LocateAnything-3B, c32291ca). Ne pas modifier : toute glu WAMA va dans
le PoC (scripts/poc_locate_anything.py) puis, si validé, dans la brique commune détection
(ROADMAP §17 étape 2). Licence NVIDIA non-commerciale — usage recherche uniquement.
"""
import re
...
class LocateAnythingWorker:
    ...
    def __init__(self, model_path: str, device: str = "cuda", dtype=torch.bfloat16):
        ...
        self.model = AutoModel.from_pretrained(
            ...
            # Écart au README (seul) : pic RAM ~8 Go au lieu de ~16 (double copie state_dict).
            # Hôte 32 Go / WSL capée à 16 — 2 freezes durs le 2026-07-27 sans ça.
