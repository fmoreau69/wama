...
| **Gestion mémoire GPU/RAM** | VRAM centralisée + stratégies d'offload CPU pour toutes les apps ; nettoyage, monitoring, tracking | `wama/model_manager/services/memory_manager.py` | — | 15 |
...
| **File d'attente (front)** | Comportements communs des files : collapse de batch persisté, focus card, data-wama-* | `wama/common/static/common/js/wama-queue.js` | `CARD_DESIGN.md` | 41 |
...
| **Chips méta des cards** | Chips de l'état concis GÉNÉRÉS du schéma params (chip=True) — jamais écrits par app | `wama/common/utils/card_chips.py` | `CARD_DESIGN.md §10.3` | 17 |
